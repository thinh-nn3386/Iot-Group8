...
class EventTask implements Runnable {
  ...
  /**
   *Tạo mội task gửi body cho initial state cl
   * @param accessKey  key được tạo ra cho mỗi data bucket
   * @param endpoint  url cho stream data
   * @param customHeaders  header
   * @param body  phần dữ liệu gửi đi
   */
